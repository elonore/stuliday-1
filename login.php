                ...
                <form
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" name="user_email" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="Entrez votre mail...">
                    ...
                    <button type="submit" name="submit-login"
                        class="btn btn-primary col-md-4 offset-3">Connexion</button>
                </form>
            </div>
            <div class="col-md-6">
                <h1>S'inscrire</h1>
                <form
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" name="user_email_signup" class="form-control" id="exampleInputEmail2"
                            aria-describedby="emailHelp" placeholder="Entrez votre mail...">
                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone
                            else.</small>
                    </div>
                    <div class="form-group col-md-10">
                        ...
                        <input type="password" name="user_password_signup" class="form-control"
                            id="exampleInputPassword2" placeholder="Entrez votre mot de passe...">
                    </div>
                    <div class="form-group col-md-10">
                        <label for="exampleInputPassword3">Re-type your Password</label>
                        <input type="password" name="user_password_2_signup" class="form-control"
                            id="exampleInputPassword3" placeholder="Password">
                    </div>
                    <button type="submit" name="submit-signup"
                        class="btn btn-primary col-md-4 offset-3">Inscription</button>
                </form>
            </div>
        </div>
    </div>
