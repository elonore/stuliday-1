        ...
        <form action="inc/create-annonces-post.php" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="title" id="title_annonce"
                        placeholder="Joli appartement situé en plein centre-ville">
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="address" id="address_annonce"
                        placeholder="Adresse complète avec code postal inclus" class="col-md-12">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="description" rows="3"
                        placeholder="Description détaillée de l'annonce" id="desc_annonce" required></textarea>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="city_annonce">Ville</label>
                    <input type="text" class="form-control" name="city" id="city_annonce"
                        placeholder="Adresse complète avec code postal inclus" class="col-md-12">
                </div>
                <div class="form-group col-md-12">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="price_annonce" name="price" min="1" max="999"
                        required>
                </div>
            ...
            <input type="submit" class="btn btn-primary col-6 offset-md-3" name="submit_annonce"
                value="Créer votre annnonce" />
        </form>
    </div>
</section>
